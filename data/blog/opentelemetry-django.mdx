...
SigNoz Cloud enables first-class OpenTelemetry support with guided installation steps for instrumeting all parts of your tech stack, including infrastructure, and supports 50+ data sources. [Sign up today](https://signoz.io/teams/) to get unlimited access to all features for 30 days.

...
<figure data-zoomable align='center'>
    <video
        ...
        src="/img/blog/2025/11/django-signoz-walkthrough.mp4"
        width="100%"
        controls={true}
    >
        Your browser does not support the video tag.
    </video>
    <figcaption><i>An overview of SigNoz's APM and telemetry visualization capabilities in one pane</i></figcaption>
</figure>
